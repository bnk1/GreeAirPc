namespace GreeAirPC.Gree
{
    ...
    internal static class Scanner
    {
        ...
        public static async Task<List<Database.AirCondModel>> Scan(string broadcastAddresses)
        {
            var foundUnits = new List<Database.AirCondModel>();
                ...
                using (var udp = new UdpClient())
                {
                    ...
                    for (int i = 0; i < 50; ++i)
                    {
                        if (udp.Available > 0)
                        {
                            ...
                            foundUnits.Add(new Database.AirCondModel()
                            {
